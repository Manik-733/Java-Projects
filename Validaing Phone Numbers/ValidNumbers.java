...

    {
        ...
        while (input.hasNext()) {
            ...
            try { // try block initialisation
                ...
                // Storing different parts of numbers using substring and then trimming white
                // space
            ...
            catch (NumberFormatException nfe) // NumberFormatException is already existing java exception class. So we
                                              // will just catch it.
            {
                invalidNumbers.println("Testing this Number: " + nextNumber);
                invalidNumbers.println("Number format error. Number provided " + nextNumber
                        + " contains letters. Please add numbers only \n");
            }
